...
export const navItems = [
  ...
  { key: 'applications', title: 'Applications', href: paths.dashboard.applications, icon: 'applications' },
  { key: 'pharmacies', title: 'Pharmacies', href: paths.dashboard.pharmacies, icon: 'pharmacy' },
